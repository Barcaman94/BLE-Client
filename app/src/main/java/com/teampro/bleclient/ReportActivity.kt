...
fun ReportScreen(
    ...
    Column(
        ...
        Button(
            onClick = {
                val operation =
                    "{\"url\":\"/v2/report\",\"body\":{\"created_at__gte\":\"2025-01-01T00:00:00Z\",\"created_at__lte\":\"2025-07-29T23:59:59Z\"}}"
            ...
            Text("Получить отчет ZX v2")
        }

        Button(
            onClick = {
                val operation =
                    "{\"url\":\"/report-z-x\",\"body\":{\"created_at__gte\":\"2025-01-01T00:00:00Z\",\"created_at__lte\":\"2025-07-29T23:59:59Z\"}}"
                resultText = "Отправлено: $operation"
            ...
            Text("Получить отчет ZX")
        }

        Button(
            onClick = {
                val operation =
                    "{\"url\":\"/intermediate_work\",\"body\":{}}"
                resultText = "Отправлено: $operation"
                CoroutineScope(Dispatchers.Main).launch {
                    bleClient?.sendCommand(operation)
                }
            ...
            Text("Получить промежу́точный отчет")
        }
